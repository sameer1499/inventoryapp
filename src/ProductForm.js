    ...
    render () {
        return (
            <form>
                ...
                <p>
                    <label>Warehouse Stock <br />
                    <input type="text" className="form-control" name="warehousestock" onChange={this.handleChange} value={this.state.product.warehousestock} placeholder="Ex: 100"/></label>
                </p>
                <p>
                    <label>In Stock <br />
